...
from metahandlerpt import metahandlers
from metahandlerpt import metacontainers
...
class link:
    def __init__(self):
        ...
        self.tvdb_series = 'http://thetvdb.com/api/GetSeriesByRemoteID.php?imdbid=tt%s&language=pt'
        self.tvdb_series2 = 'http://thetvdb.com/api/GetSeries.php?seriesname=%s&language=pt'
        self.tvdb_episodes = 'http://thetvdb.com/api/%s/series/%s/all/pt.xml'
